...
#ifndef ex13_19movemessage_h
#define ex13_19movemessage_h
...
private:
    ...
    // tool function for move constructor and assigne constructor
...
Message::Message(Message &&old) 
    : contents(std::move(old.contents)) {
        move_Folders(&old);
    }
...
// tool function, remove_Fodlers()
// move the folders to new destiney
