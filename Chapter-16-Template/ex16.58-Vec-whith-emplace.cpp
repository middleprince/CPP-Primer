...
int main() {
    ...
    cout << "## Test for function emplace_back() \n";
    strVec.emplace_back(10, 'c');
    cout << "strVec is: ";
    for (const auto& item : strVec) cout << item << " ";
    cout << endl;

    cout << "## Test for function emplace_back() for right value \n";
    string s1("this is s1"), s2("this is s2");
    strVec.emplace_back(s1 + s2);
    cout << "strVec is: ";
    for (const auto& item : strVec) cout << item << " ";
    ...
    //cout << "## Test for function emplace_back() \n";  
    //intVec2.emplace_back(10, 100);
    //for (const auto& item : intVec2) cout << item << " ";
    //cout << endl;
 
    cout << "## Test for function emplace_back() for right value \n";  
    int i = 9999;
    intVec2.emplace_back(std::move(i));
    for (const auto& item : intVec2) cout << item << " ";
    cout << endl;
