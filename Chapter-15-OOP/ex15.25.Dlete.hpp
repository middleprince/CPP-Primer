...
#ifndef ex15_16_Delete_h
#define ex15_16_Delte_h
...
public:
    // if remove the default constructor
    Disc_Quote() = default;
...
public:
    // if Disc_Quote had not define defualt constructor then:
    //  for Bulk_Quot constructor : explicitly defaulted default 
